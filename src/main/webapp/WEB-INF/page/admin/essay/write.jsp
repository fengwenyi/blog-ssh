...
<body>
	<div class="main" id="main">
        <form action="/admin/essay-write-impl" method="post" enctype="multipart/form-data">
            <div class="div-text"><input type="text" name="title" placeholder="写下文章标题"></div>
            ...
            <!-- summary -->
            <div class="div-summary"><textarea class="summary" name="summary" placeholder="摘要"></textarea></div>
            <!-- file -->
            <div class="div-file">
                ...
                <div class="img">
                    ...
                    <img src="http://www.w3school.com.cn/i/eg_tulip.jpg" height="80" id="img-preview">
                </div>
                <span class="reUpload" id="reUpload"><a href="javascript:;">重新上传</a></span>
            </div>
            <!-- tag & submit -->
            <div class="div-buttom"><input class="tag" type="text" name="tag" placeholder="标签，以逗号(,)隔开">
                <input class="submit" type="submit" name="" value="发表"></div>
        </form>
    </div>
</body>
</html>