...
<head>
	...
	<style type="text/css">
		...
		.main .table .tr-title .content{

		}
		.main .table .tr-title .essay{
			width: 100px;
		}
		.main .table .tr-title .user{
			width: 50px;
		}
...
<body>
	...
	<nav class="nav" id="nav">
		<ul>
			...
			<li class="comment in"><a href="javascript:;" id="nav-comment"><i class="fa fa-comments"></i></a></li>
        ...
        <table class="table" id="table">
			...
			<c:forEach var="l" items="${list}">
				<tr class="tr-value">
					...
					<td>${l.content}</td>
					<td align="center">${l.essay.title}</td>
					<td align="center">${l.user.id}</td>
					<td align="center">
